...
<body>
	<div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding: 20px 30px 0 0;">
			...
			<div class="layui-input-block">
				<div class="layui-col-md12">
					...
					<input type="text" name="jobName" lay-verify="required|jobName" lay-verType="tips" placeholder="请输入名称"
						autocomplete="off" class="layui-input" value="${sysJob.jobName}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			<button class="layui-btn layui-hide" lay-submit lay-filter="edit-sysJob-submit" id="edit-sysJob-submit">提交</button>
		</div>
	</div>

<@scripts>
	<script src="${application.getContextPath()}/js/admin/sys/job/job_edit.js"></script>
	<script>
		layui.config({
