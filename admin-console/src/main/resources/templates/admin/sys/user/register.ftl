...
<body>
<div class="layui-form reg-body" style="padding: 20px 30px 0 0;" lay-filter="register" id="register">
    ...
    <div class="layui-form-item">
        <button class="layui-btn layui-hide" lay-submit lay-filter="register-submit" id="register-submit">提交</button>
    </div>
</div>
<@scripts>
