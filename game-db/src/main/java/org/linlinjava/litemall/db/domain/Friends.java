...
public class Friends implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.Friends.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.Friends.Deleted.NOT_DELETED.value());
    }



    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.Friends.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.Friends.Deleted.NOT_DELETED.value();
    }
