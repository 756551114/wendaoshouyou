...
public class SaleGood implements Cloneable, Serializable, Comparable<SaleGood> {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.SaleGood.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.SaleGood.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.SaleGood.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.SaleGood.Deleted.NOT_DELETED.value();
    }
