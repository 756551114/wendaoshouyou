...
public class Skilljineng implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.Skilljineng.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.Skilljineng.Deleted.NOT_DELETED.value());
    }
    ...
    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.Skilljineng.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.Skilljineng.Deleted.NOT_DELETED.value();
    }
