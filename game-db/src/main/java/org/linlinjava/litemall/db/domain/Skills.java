...
public class Skills implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.Skills.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.Skills.Deleted.NOT_DELETED.value());
    }


    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.Skills.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.Skills.Deleted.NOT_DELETED.value();
    }
