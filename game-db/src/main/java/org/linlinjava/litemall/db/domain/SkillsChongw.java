...
public class SkillsChongw implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.SkillsChongw.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.SkillsChongw.Deleted.NOT_DELETED.value());
    }



    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.SkillsChongw.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.SkillsChongw.Deleted.NOT_DELETED.value();
    }
