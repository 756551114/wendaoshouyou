...
public class StoreInfo implements Cloneable, Serializable {
    ...
    public void andLogicalDeleted(boolean deleted) {
        this.setDeleted(deleted ? org.linlinjava.litemall.db.domain.StoreInfo.Deleted.IS_DELETED.value() : org.linlinjava.litemall.db.domain.StoreInfo.Deleted.NOT_DELETED.value());
    }



    static {
        IS_DELETED = org.linlinjava.litemall.db.domain.StoreInfo.Deleted.IS_DELETED.value();
        NOT_DELETED = org.linlinjava.litemall.db.domain.StoreInfo.Deleted.NOT_DELETED.value();
    }
