...
public class DaySignPrizeExample {
    ...
    protected List<org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria> oredCriteria = new ArrayList();
    ...
    public List<org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria> getOredCriteria() {
        return this.oredCriteria;
    }

    public void or(org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria criteria) {
        this.oredCriteria.add(criteria);
    }

    public org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria or() {
        org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria criteria = this.createCriteriaInternal();
        this.oredCriteria.add(criteria);
        return criteria;
    }
    ...
    public org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria createCriteria() {
        org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria criteria = this.createCriteriaInternal();
    ...
    protected org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria createCriteriaInternal() {
        org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria criteria = new org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria(this);
        return criteria;
    }
    ...
    public static org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria newAndCreateCriteria() {
        DaySignPrizeExample example = new DaySignPrizeExample();
        return example.createCriteria();
    }

    public DaySignPrizeExample when(boolean condition, org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
    ...
    public DaySignPrizeExample when(boolean condition, org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.IExampleWhen then, org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        /** @deprecated */
        @Deprecated
        public Criteria andIf(boolean ifAdd, org.linlinjava.litemall.db.domain.example.DaySignPrizeExample.Criteria.ICriteriaAdd add) {
            if (ifAdd) {
                add.add(this);
            }
