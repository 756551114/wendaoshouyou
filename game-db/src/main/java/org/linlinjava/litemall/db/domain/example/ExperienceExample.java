...
public class ExperienceExample {
    ...
    protected List<org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria> oredCriteria = new ArrayList();
    ...
    public List<org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria> getOredCriteria() {
        return this.oredCriteria;
    }

    public void or(org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria criteria) {
        this.oredCriteria.add(criteria);
    }

    public org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria or() {
        org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria criteria = this.createCriteriaInternal();
        this.oredCriteria.add(criteria);
        return criteria;
    }
    ...
    public org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria createCriteria() {
        org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria criteria = this.createCriteriaInternal();
    ...
    protected org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria createCriteriaInternal() {
        org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria criteria = new org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria(this);
        return criteria;
    }
    ...
    public static org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria newAndCreateCriteria() {
        ExperienceExample example = new ExperienceExample();
        return example.createCriteria();
    }

    public ExperienceExample when(boolean condition, org.linlinjava.litemall.db.domain.example.ExperienceExample.IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
    ...
    public ExperienceExample when(boolean condition, org.linlinjava.litemall.db.domain.example.ExperienceExample.IExampleWhen then, org.linlinjava.litemall.db.domain.example.ExperienceExample.IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        /** @deprecated */
        @Deprecated
        public Criteria andIf(boolean ifAdd, org.linlinjava.litemall.db.domain.example.ExperienceExample.Criteria.ICriteriaAdd add) {
            if (ifAdd) {
                add.add(this);
            }
