...
public class GroceriesShopExample {
    ...
    protected List<org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria> oredCriteria = new ArrayList();
    ...
    public List<org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria> getOredCriteria() {
        return this.oredCriteria;
    }

    public void or(org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria criteria) {
        this.oredCriteria.add(criteria);
    }

    public org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria or() {
        org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria criteria = this.createCriteriaInternal();
        this.oredCriteria.add(criteria);
        return criteria;
    }
    ...
    public org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria createCriteria() {
        org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria criteria = this.createCriteriaInternal();
    ...
    protected org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria createCriteriaInternal() {
        org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria criteria = new org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria(this);
        return criteria;
    }
    ...
    public static org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria newAndCreateCriteria() {
        GroceriesShopExample example = new GroceriesShopExample();
        return example.createCriteria();
    }

    public GroceriesShopExample when(boolean condition, org.linlinjava.litemall.db.domain.example.GroceriesShopExample.IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
    ...
    public GroceriesShopExample when(boolean condition, org.linlinjava.litemall.db.domain.example.GroceriesShopExample.IExampleWhen then, org.linlinjava.litemall.db.domain.example.GroceriesShopExample.IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        /** @deprecated */
        @Deprecated
        public Criteria andIf(boolean ifAdd, org.linlinjava.litemall.db.domain.example.GroceriesShopExample.Criteria.ICriteriaAdd add) {
            if (ifAdd) {
                add.add(this);
            }
