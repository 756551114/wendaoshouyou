...
public class NpcExample {
    ...
    protected List<org.linlinjava.litemall.db.domain.example.NpcExample.Criteria> oredCriteria = new ArrayList();
    ...
    public List<org.linlinjava.litemall.db.domain.example.NpcExample.Criteria> getOredCriteria() {
        return this.oredCriteria;
    }

    public void or(org.linlinjava.litemall.db.domain.example.NpcExample.Criteria criteria) {
        this.oredCriteria.add(criteria);
    }

    public org.linlinjava.litemall.db.domain.example.NpcExample.Criteria or() {
        org.linlinjava.litemall.db.domain.example.NpcExample.Criteria criteria = this.createCriteriaInternal();
        this.oredCriteria.add(criteria);
        return criteria;
    }
    ...
    public org.linlinjava.litemall.db.domain.example.NpcExample.Criteria createCriteria() {
        org.linlinjava.litemall.db.domain.example.NpcExample.Criteria criteria = this.createCriteriaInternal();
    ...
    protected org.linlinjava.litemall.db.domain.example.NpcExample.Criteria createCriteriaInternal() {
        org.linlinjava.litemall.db.domain.example.NpcExample.Criteria criteria = new org.linlinjava.litemall.db.domain.example.NpcExample.Criteria(this);
        return criteria;
    }
    ...
    public static org.linlinjava.litemall.db.domain.example.NpcExample.Criteria newAndCreateCriteria() {
        NpcExample example = new NpcExample();
        return example.createCriteria();
    }

    public NpcExample when(boolean condition, org.linlinjava.litemall.db.domain.example.NpcExample.IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
    ...
    public NpcExample when(boolean condition, org.linlinjava.litemall.db.domain.example.NpcExample.IExampleWhen then, org.linlinjava.litemall.db.domain.example.NpcExample.IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        /** @deprecated */
        @Deprecated
        public Criteria andIf(boolean ifAdd, org.linlinjava.litemall.db.domain.example.NpcExample.Criteria.ICriteriaAdd add) {
            if (ifAdd) {
                add.add(this);
            }
