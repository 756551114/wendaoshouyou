...
public class SkilldataExample {
    ...
    protected List<org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria> oredCriteria = new ArrayList();
    ...
    public List<org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria> getOredCriteria() {
        return this.oredCriteria;
    }

    public void or(org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria criteria) {
        this.oredCriteria.add(criteria);
    }

    public org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria or() {
        org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria criteria = this.createCriteriaInternal();
        this.oredCriteria.add(criteria);
        return criteria;
    }
    ...
    public org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria createCriteria() {
        org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria criteria = this.createCriteriaInternal();
    ...
    protected org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria createCriteriaInternal() {
        org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria criteria = new org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria(this);
        return criteria;
    }
    ...
    public static org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria newAndCreateCriteria() {
        SkilldataExample example = new SkilldataExample();
        return example.createCriteria();
    }

    public SkilldataExample when(boolean condition, org.linlinjava.litemall.db.domain.example.SkilldataExample.IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
    ...
    public SkilldataExample when(boolean condition, org.linlinjava.litemall.db.domain.example.SkilldataExample.IExampleWhen then, org.linlinjava.litemall.db.domain.example.SkilldataExample.IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        /** @deprecated */
        @Deprecated
        public Criteria andIf(boolean ifAdd, org.linlinjava.litemall.db.domain.example.SkilldataExample.Criteria.ICriteriaAdd add) {
            if (ifAdd) {
                add.add(this);
            }
