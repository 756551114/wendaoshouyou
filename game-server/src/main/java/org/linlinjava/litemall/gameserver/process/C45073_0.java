...
public class C45073_0 implements GameHandler {
    ...
    final static String doubleSurName[] = {"万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方",
    ...
    final static String[] word = {"一", "乙", "二", "十", "丁", "厂", "七", "卜", "人", "入", "八", "九", "几", "儿", "了", "力", "乃", "刀", "又",
    ...
    public String getRandomJianHan() {
        while (true) {
            String ret = randomName(false, RandomUtil.randomInt(2, 5));
