...
<head>
    ...
    <link rel="stylesheet" media="all and (orientation:landscape)" href="/vip4/mobile/sdk/css/paging.css">
    <link rel="stylesheet" media="all and (orientation:portrait)" href="/vip4/mobile/sdk/css/portrait/common.css">
    <link rel="stylesheet" media="all and (orientation:portrait)" href="/vip4/mobile/sdk/css/portrait/paging.css">
</head>
<body>
<div class="header pr">
...
<div class="account_center_change">
    ...
    <ul class="clearfix">
        ...
        <li><a href="javascript:;" id="switchAccount">
                <dl>
        ...
        <li><a href="javascript:;">
                <dl>
                    ...
                    <dd>暂未开放<i class="icon"></i></dd>
                </dl>
            </a></li>
        <!-- <li><a href="javascript:;">
            <dl>
                <dt class="dt4"><i class="icon"></i></dt>
                <dd>绑定身份证<i class="icon"></i></dd>
            </dl>
        </a></li> -->
    </ul>
</div>
...
<script src="/vip4/mobile/sdk/js/paging.js"></script>
<script>
    $(function(){
        $('.account_center_change ul li:eq(0)')
            .on('touchend',function(){
                location.href='change_password.html?userName='+$('#account').html().split('当前账号：')[1];
            })
    ...
    $(function(){
        ...
        $('.account_center_change ul li:eq(2)')
            .on('touchend',function(){
                var bindStatus = jsObject.getBindStatus();
                if(bindStatus == "1"){
                    jsObject.showMsg('该账号已绑定');
                    //popup_fn('该账号已绑定');
                }else if(bindStatus == "2"){
                    location.href='bind_phone.html';
                    //		jsObject.bindPhone();
                }else{
